...
access::allow("1");
 ...
 $quiz_type=$row['quiz_type']=="1" ? "Quiz" : "Survey";
 $show_results=$row['show_results']=="1" ? "Yes" : "No";
 $results_by=$row['results_mode'] == "1" ? "By Point" : "By Percent";
 $pass_score=$row['pass_score'];
 $test_time=$row['quiz_time'];

 $hedaers = array("User ID", "Name", "Surname","User name","Status","Success","Total point","&nbsp;");
