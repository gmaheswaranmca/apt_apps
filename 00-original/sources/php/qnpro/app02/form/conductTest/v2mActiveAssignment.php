...
class ActiveAssignmentPageController	// change 1b
{
	...
	public function html(){			
		...
		if(!isset($_SESSION['txtLogin'])){
			...
			$mdasscode = $oConductTestDb->QueryAssCodeByUser($p_user_id);
			$mdasslink = $oConductTestDb->QueryAssLink();
			//
			$outdata = array('IsLoggedIn'=>1,'vhtml'=>$vhtml,
				"mdassignment"=>$mdassignment, "mdasscode"=>$mdasscode, "mdasslink"=>$mdasslink, 
