...
class ActiveAssignmentPageController	// change 1b
{
	...
	{			
		...
		$vmenu = $this->phpUtil->output_form(realpath(FS_DIR_ACTASS_PC.'../userAndModule/MenusView.php'));
		...
		if(!isset($_SESSION['txtLogin'])){
			...
			//
			$outdata = array('IsLoggedIn'=>1,'vhtml'=>$vhtml,'vmenu'=>$vmenu,"mdassignment"=>$mdassignment, 
					"user_id"=>$p_user_id, "user_name"=>$p_user, "mdmenu"=>$mdmenu, "mdlivetest"=>$mdlivetest);
		}
