		...
		/*2. dao-read*/
			...
			{			
				...
				if(isset($_SESSION['txtLogin'])){
					$v_out = $this->phpUtil->output(1, 'Already Logged In', array("a" => 'Already Logged In', "b" => $_SESSION['txtLogin']));
				}else{
					$v_out = $this->phpUtil->output(2, 'Yet To Login', array("a"=> 'Yet To Login', "b" => ""));
				}
