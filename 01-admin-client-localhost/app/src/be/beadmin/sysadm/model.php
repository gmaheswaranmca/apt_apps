<?php 
	...
	class SysAdmModel{
		...
		public function QueryAptJobConfig()	{
			return  $this->wmd->QueryNoParam($this->sql->QueryAptJobConfig);
		}
		public function QueryAppHmStartup()	{
			...
			/* $aptJobConfig = $this->wmd->QueryNoParam($this->sql->QueryAptJobConfig);
			$job_master_path = $aptJobConfig[0]["job_master_path"];
			//$res = $phpUtil->readFile($job_master_path);
			$res = json_encode(array('job_master_path' => $job_master_path));
