...
<div align="center" id="divQst" class="qst_main_table_li">
			...
			<table border="0" class="qst_ans_table" cellspacing="10" >
				...
				<tr style="background-color:#eee;color:navy;">
					<td style="padding:5px;border:1px solid #ccc;">
						...
						<input type="radio" {{#IsUserAnswered}}checked{{/IsUserAnswered}} id="rdAns" name="rdAns" value="{{id}}">
	...
	<tr class="c_list_item_gr">
		<td style="padding:5px;">
			<div id="myQBtns">
			<input type="button" class="aptBtn"  style="min-width:50px;"  onclick="TakeTestViewRender.PrevQn();" value="<<">
			{{^IsLastQn}}<input type="button" class="aptBtn"  style="min-width:50px;"  onclick="TakeTestViewRender.NextQn();" value="  Save >>  ">{{/IsLastQn}}
