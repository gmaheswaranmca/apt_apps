...
<table class="desc_text">
    ...
    <tr>
        <td colspan="2" align="center">
            <input class="st_button" type="submit" name="btnSave" value="Save" id="btnSave" onclick="return checkform();" />
            <input class="st_button" type="button" name="btnCancel" value="Cancel" id="btnCancel" onclick="javascript:window.location.href='?module=local_users'" />
        </td>
    </tr>
</table>
