...
$util_path = realpath(FS_DIR_ACTASS_PC.'../../sdk/ar6PhpUtil.php');	
...
class OldAssignmentPageController	// change 1b
{
	private $m_method = ''; 
	...
	public function frm_init(){
		...
		if(!($v_m==='')){
			...
			{
				case 'html':	// change 2a
					$html_page = realpath(FS_DIR_ACTASS_PC.'OldAssignmentView.php');
				...
				case 'menu_htm':	// change 2a
					...
					break;		
				case 'dao_list':
					$this->BmQueryOldAssessesmentByUser();
					break;
					break;				
				case 'daomodule_get':
	...
	/*2. dao-read*/
		public function BmQueryOldAssessesmentByUser()
		{
			//input			
			...
			$v_r_no = 989;
			{
				...
				$v_dao_result = $oConductTestDb->QueryOldAssessesmentByUser($p_user_id);
...
$oOldAssignmentPageController = new OldAssignmentPageController();	// change 7
